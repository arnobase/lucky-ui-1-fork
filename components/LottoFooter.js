  ...
  return (<>
    ...
    <div class="flex items-center justify-center ">
      <div class="margin-auto text-center text-lg align-middle leading-8">
        <div></div>
        <div>Lotto is a game made by <ExportedImage className="inline px-1" src={lucky_logo} alt="Lucky" height={33} width={33} />Lucky in a partnership with <ExportedImage className="inline" src={pink_logo} alt="Pink" height={20} width={25} /><span className={unbounded.className+' align-middle pl-1'}>PI<span className='mirrorX inline-block'>N</span>K</span></div>
        <div>built on <ExportedImage className="inline" src={astar_logo_name} alt="Astar" height={15} width={100} />and
        <ExportedImage className="inline ml-1 mr-2" src={phala_logo} alt="Phala" height={23} width={23} /><ExportedImage className="inline mr-1" src={phala_name} alt="Phala Network" height={23} width={70} /></div>
